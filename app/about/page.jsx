  ...
  return (
    <>
      ...
      <div ref={certificateRef} className="flex flex-col items-center mb-16">
        ...
        <motion.p
          className="text-xl text-[#860764] mt-4 font-semibold"
          initial={{ opacity: 0 }}
      ...
      >
        <motion.p
          className="text-[#860764] text-lg mb-4"
          variants={fadeIn}
          ...
          <div className="container mx-auto">
            ...
            >
              {[
                ...
                {
                  name: "L&T",
                  logo: "https://assets.entrepreneur.com/content/3x2/2000/1722238308-LTThumbnail.jpg",
                },
                {
                ...
                },
                {
                  ...
                  logo: "https://www.eqimg.com/images/2024/1280x720/12272024-image6-equitymaster.jpg",
                },
                {
